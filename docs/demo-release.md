...
- Privacy summary: demo data stays on device unless the user explicitly shares or exports summaries.
...
- Demo sample data loads caffeine, sleep, and vigilance records.
- Demo sample data can be removed without deleting non-demo records.
...
- Load demo sample data and confirm sleep, caffeine, vigilance, insights, and export surfaces populate.
- Remove demo sample data and confirm non-demo records remain intact.
